...
@section('content')
    ...
    <section class="section-slide">
        <div class="wrap-slick1 rs2-slick1">
            <div class="slick1">
                <div class="item-slick1 bg-overlay1" style="background-image: url({{ asset('frontend/images/slide-05.jpg') }});"
                ...
                <div class="item-slick1 bg-overlay1" style="background-image: url({{ asset('frontend/images/slide-06.jpg') }});"
                ...
                <div class="item-slick1 bg-overlay1" style="background-image: url({{ asset('frontend/images/slide-07.jpg') }});"
